                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" aria-controls="dataTable"  aria-label="Position: activate to sort column ascending" style="width: 296px;">Tên danh mục</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm" href="{{ route('category.edit',['category' => $category]) }}">Sửa</a>
                                        </td>
